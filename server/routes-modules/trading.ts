...
export function registerTradingRoutes(app: Express): void {
  ...
  app.post("/api/trading/paper-trades/authorize", isAuthenticated, async (req: any, res) => {
    ...
    const authorization = await authorizePaperTrade({
      ...
      marketStructure: req.body.marketStructure ? String(req.body.marketStructure) : undefined,
      liquidityAnalysis: req.body.liquidityAnalysis ? String(req.body.liquidityAnalysis) : undefined,
      timeframeAlignment: req.body.timeframeAlignment || undefined,
      session: req.body.session ? String(req.body.session) : undefined,
      newsFilter: req.body.newsFilter ? String(req.body.newsFilter) : undefined,
      correlationExposure: req.body.correlationExposure ? String(req.body.correlationExposure) : undefined,
