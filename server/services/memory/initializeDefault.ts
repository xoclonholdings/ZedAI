...
export async function initializeDefaultCoreMemory(): Promise<void> {
  ...
  const defaults: Array<{
    ...
    },
    {
      ...
      description: "Backward-compatible ZAR personality composite (fallback)",
      adminOnly: true,
    },
    {
      key: "rules",
      ...
      description: "Backward-compatible ZAR rules composite (fallback)",
      adminOnly: true,
    },
    {
      key: "default_context",
      ...
      description: "Backward-compatible ZAR default context composite (fallback)",
      adminOnly: true,
    },
    {
      key: "access",
      ...
      description: "Backward-compatible ZAR access composite (fallback)",
      adminOnly: true,
    },
    {
