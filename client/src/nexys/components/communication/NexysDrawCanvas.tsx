...
interface NexysDrawCanvasProps {
 ...
 * sketch as a real attachment through the same /upload route NexysFileUpload
 * uses. Not a full illustration app; just quick freehand markup, like the
 * iMessage sketch tool.
 */
export function NexysDrawCanvas({ ensureConversationId, onSent }: NexysDrawCanvasProps) {
