 ...
 */
export function NexysLiveClock({ visible }: { readonly visible: boolean }) {
  const { now } = useNexysLiveMoment();
  return (
    <div
 ...
 */
export function NexysLiveDate({ visible }: { readonly visible: boolean }) {
  const { now } = useNexysLiveMoment();
  return (
    <div
 ...
 */
export function NexysLiveQuote({ visible }: { readonly visible: boolean }) {
  const { part } = useNexysLiveMoment();
