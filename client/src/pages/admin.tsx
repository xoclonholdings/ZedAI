                  ...
                  <CardContent>
                    <div className="grid grid-cols-2 gap-4">
                      <div>
                        ...
                        {status.orchestrator?.active?.map((a: string) => (
                      ...
                      <div>
                        <p className="text-xs text-muted-foreground mb-2">Stubbed (pending setup)</p>
                        {status.orchestrator?.stubbed?.map((a: string) => (
                          <div key={a} className="flex items-center gap-2 mb-1">
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {Object.entries(ruleset).map(([filename, content]) => (
                <Card
                  key={filename}
                  className={`zed-glass border-white/10 cursor-pointer transition-all ${
                    editingFile === filename ? "border-purple-500/50" : "hover:border-white/20"
                  }`}
                ...
                >
                  ...
                  <CardContent>
                    <pre className="text-xs text-muted-foreground overflow-hidden max-h-16 leading-relaxed">
                      {content || "(empty)"}
                    </pre>
                  </CardContent>
                </Card>
