        ...
        <div className="space-y-3">
            ...
            <div className="space-y-2">
                <div className="relative">
                        <label htmlFor="username" className="block text-xs font-black text-gray-200 mb-1 font-space-grotesk tracking-wide">
                            Username
                        </label>
                        <div className="relative">
                ...
                <div className="relative">
                        <label htmlFor="email" className="block text-xs font-black text-gray-200 mb-1 font-space-grotesk tracking-wide">
                            Email
                        </label>
                        <div className="relative">
                ...
                <div className="relative">
                        <label htmlFor="password" className="block text-xs font-black text-gray-200 mb-1 font-space-grotesk tracking-wide">
                            Password
                        </label>
                        <div className="relative">
                ...
                <div className="relative">
                        <label htmlFor="confirmPassword" className="block text-xs font-black text-gray-200 mb-1 font-space-grotesk tracking-wide">
                            Confirm Password
                        </label>
                        <div className="relative">
                            <Lock className="absolute left-3 top-2.5 w-4 h-4 text-gray-400 drop-shadow-sm" />
