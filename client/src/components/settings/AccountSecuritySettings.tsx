 ...
 *
 * Shows the current account, access level, and a Sign out button.
 * Same atoms as the rest of Settings for consistency.
 */
  ...
  return (
    <div>
      ...
      <p className="mt-8 pt-5 border-t border-white/[0.06] text-[12.5px] text-white/40 leading-snug max-w-full sm:max-w-[62ch]">
        Password and session-timeout policy live in the Admin panel under Security.
      </p>
    </div>
  );
}
