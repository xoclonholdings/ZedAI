...
export function NexusDeveloperInspector() {
  ...
  return (
    <section className="rounded-2xl border border-amber-300/20 bg-amber-300/[0.04] p-4 text-white">
      <div className="flex items-center gap-3">
        ...
        <div>
          <div className="text-[12px] font-semibold text-white">Nexus Developer Inspector</div>
          <div className="text-[11px] text-white/45">
            Visible only in development with debug=nexus
          </div>
        </div>
      </div>
