                    ...
                    <div className="max-w-7xl mx-auto flex justify-between items-center relative z-10">
                        <div className="flex items-center">
                            ...
                            <div className="ml-0 -mt-1">
                                <ZedLogo className="w-3 h-3 drop-shadow-lg" />
                            </div>
                        </div>
                        <div className="space-x-2">
                            <button
                                onClick={() => setLocation('/login')}
                                className="px-4 py-2 border-2 border-purple-500/50 text-purple-400 rounded-lg hover:bg-purple-500/20 hover:border-purple-400 transition-all duration-300 font-space-grotesk font-black text-xs tracking-wide backdrop-blur-sm shadow-lg hover:shadow-purple-500/25 transform hover:scale-105"
                            >
                                Login
                            </button>
                            <button
                                onClick={() => setLocation('/onboarding')}
                                className="px-4 py-2 bg-gradient-to-r from-purple-600 to-cyan-600 text-white rounded-lg hover:from-purple-700 hover:to-cyan-700 transition-all duration-300 shadow-xl shadow-purple-500/30 hover:shadow-purple-500/50 font-space-grotesk font-black text-xs tracking-wide transform hover:scale-105 hover:-translate-y-0.5"
                            >
                                Sign Up
                            </button>
                        </div>
